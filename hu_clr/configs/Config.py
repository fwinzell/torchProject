...
def get_config():
    ...
    data_root_dir = '/home/fi5666wi/Documents/Prostate images'
    ...
    c = Config(
        ...
        train_sample=1.0,  # sample rate for training set
        val_split=0.1,
        ...
        data_dir=os.path.join(data_root_dir, 'train_data_with_gt_3_classes'),  # This is where your training and validation data is stored
        data_test_dir=os.path.join(data_root_dir, 'train_data_with_gt_3_classes'),  # This is where your test data is stored
